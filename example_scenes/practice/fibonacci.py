...
class FibonacciSequence(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.play(
            Write(squares[0]), self.get_camera_centering_animation(squares[0])
        )
        ...
        for i in range(n):
            ...
            new_square = self.create_square(a).next_to(
                squares, direction, buff=0
            )
        ...
        def update_dot(dot):
            ...
            dot.set_height(
                center_dot.height
                * (self.camera.frame.height / starting_frame_height)
            )
        ...
        self.play(
            ...
            AnimationGroup(
                ...
                AnimationGroup(
                    Flash(center_dot, color=WHITE), FadeOut(center_dot)
                ),
                lag_ratio=0.9,
            ),
        )
